...
| **[`docs/`](./docs/)** | Everything written: the binding scope and platform specs, the research program, the void plan documents, the architecture poster, the deck, the wireframe. | [`docs/SCOPE-RESET.md`](./docs/SCOPE-RESET.md) |
...
4. **[`docs/PRODUCT.md`](./docs/PRODUCT.md)**, **[`BUILD-SPEC.md`](./docs/BUILD-SPEC.md)**, **[`MEMORY-SPEC.md`](./docs/MEMORY-SPEC.md)**, **[`MINDS-SPEC.md`](./docs/MINDS-SPEC.md)**, **[`PIPELINE-SPEC.md`](./docs/PIPELINE-SPEC.md)** — the old plan. **All five are void as plan** and carry a banner saying so. They are kept only because `app/` cites them by section for design rationale: read them for *why the existing code looks the way it does*, never for what to build next.
