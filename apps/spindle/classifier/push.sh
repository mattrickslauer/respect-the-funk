...
#     ./push.sh
#
# Then set that URI in infra/terraform/spindle/terraform.tfvars as classifier_image_uri and
...
echo
echo "pushed. Set this in infra/terraform/spindle/terraform.tfvars:"
echo
