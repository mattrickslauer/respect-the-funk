...
This is the visible version of `platform/web/tests/test_lease_race.py`. The tests prove
...
`platform/schema/013_lease_token.sql` closed it with one nullable column. `claim` stamps a
