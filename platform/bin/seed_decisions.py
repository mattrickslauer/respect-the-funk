...
"""Seed the decision ledger with a spread of real, replayable decisions.
    ...
    python platform/bin/seed_decisions.py                 # dry run — prints, writes nothing
    python platform/bin/seed_decisions.py --apply         # actually writes
    python platform/bin/seed_decisions.py --apply --reset # replace this script's own rows
...
SEEDED_BY = "platform/bin/seed_decisions.py"
