...
The project has already rigorously derived, and this report reuses without re-deriving, the Meta CTR-detection benchmark from [`../03-audience-models/README.md` §6](../03-audience-models/README.md#6-detecting-a-ctr-lift-the-real-cost-of-knowing):
...
**A third constraint: do the probe accounts even have the reach to generate the impressions?** Both Instagram and TikTok gate demographic audience insights behind a **100-follower minimum**, and meaningful reach ("Accounts Reached") thresholds sit above that ([Instagram Insights requirements](https://help.instagram.com/788388387972460/); [TikTok analytics demographic threshold](https://influenceflow.io/resources/tiktok-analytics-and-audience-insights-the-complete-guide-for-2026/)). Newly-created probe accounts start at zero and grow slowly (see [`../05-account-acquisition/README.md`](../05-account-acquisition/README.md) on the risks and realistic pace of account growth). Organic reach from 6–10 small, fresh accounts is nowhere near 15,478 impressions, let alone 2.3M+ — **even the cheapest single pairwise test effectively requires paid amplification, not organic probe-account posting alone.**
...
Every probe account differs simultaneously in **niche** (what topic/archetype it represents) and **content quality/execution** (how good the specific post is, who made it, what time it went up). Follower growth or engagement on Account A vs. Account B conflates both — a "math page" that grows faster than a "baby page" could mean men respond better to math content, *or* it could mean whoever runs the math page is simply better at making content, or posted at a better time, or benefited from a lucky algorithmic push. Structural virality research is unambiguous that idiosyncratic, early, largely unpredictable factors dominate individual post performance ([Goel, Anderson, Hofman & Watts, *Management Science* 2016, cited in `../03-audience-models/README.md` §8](../03-audience-models/README.md)) — so this confound is not a small nuisance, it's the dominant source of variance you'd otherwise misattribute to "niche."
...
- **Measurement**: run the same song content across 2–3 accounts near each pole (People-leaning vs. Things-leaning), using the **rotate-identical-content** design of §5, and compare **on-platform engagement (video-watch-depth ≥50%/75%, per [`../03-audience-models/README.md` §7.3](../03-audience-models/README.md))** and, where paid, CTR — exactly the metric and cost structure already validated in §4.3's "1 axis, 2 poles" row: **$143–$791** for one properly-powered pairwise test.
...
- [`../03-audience-models/README.md` §6 — CTR-lift detection cost math (15,478 / 85,284 impressions; $143 / $791 at entertainment CPM)](../03-audience-models/README.md)
- [`../03-audience-models/README.md` §1 — Meta's GEM / Andromeda / Lattice ad stack](../03-audience-models/README.md)
- [`../03-audience-models/README.md` §9.5 — "Learning Limited" / ~50 conversions/week per ad set](../03-audience-models/README.md)
- [`../05-account-acquisition/README.md` — probe/niche account growth and risk realities](../05-account-acquisition/README.md)
